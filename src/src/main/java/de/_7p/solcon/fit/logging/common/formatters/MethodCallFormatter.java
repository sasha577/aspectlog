...
public final class MethodCallFormatter {
    ...
    public static void logInvoke(
            final String targetId, final Object[] args, final LogLevel level, final Logger logger, final String methodName,
        ...
        LogUtils.log(logger, level, invokeMessage);
    }


    public static void logResult(
            final String targetId, final Object result, final LogLevel level, final Logger logger, final String methodName,
            final String clazzName) {
        ...
        LogUtils.log(logger, level, resultMessage);
    }

    public static void logException(
            final String targetId, final Throwable e, final LogLevel level, final Logger logger, final String methodName,
            final String clazzName) {
        ...
        LogUtils.log(logger, level, exceptionMessage);
    }
